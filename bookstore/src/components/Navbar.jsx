    ...
    >
      <div className="navbar">
        ...
        <div className="navbar-end space-x-3">
          ...
          <a className="cursor-pointer bg-black text-white px-3 py-2 rounded-md hover:bg-slate-800 duration-300" onClick={()=>document.getElementById("my_modal_3").showModal()}>
            Login
          </a>
          <Login />
        </div>
